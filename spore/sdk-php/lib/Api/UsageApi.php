...
class UsageApi
{
     ...
     * @return \Lalternative\Spore\Model\GetUsageUsageResponse|\Lalternative\Spore\Model\EchoHTTPError|\Lalternative\Spore\Model\EchoHTTPError
     */
     ...
     * @throws \Lalternative\Spore\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Lalternative\Spore\Model\GetUsageUsageResponse|\Lalternative\Spore\Model\EchoHTTPError|\Lalternative\Spore\Model\EchoHTTPError, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Lalternative\Spore\Model\GetUsageUsageResponse',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\Lalternative\Spore\Model\GetUsageUsageResponse';
        $request = $this->getUsageRequest($contentType);
