...
class TemplatesApi
{
     ...
     * @return \Lalternative\Spore\Model\ListTemplatesResponse|\Lalternative\Spore\Model\EchoHTTPError
     */
     ...
     * @throws \Lalternative\Spore\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Lalternative\Spore\Model\ListTemplatesResponse|\Lalternative\Spore\Model\EchoHTTPError, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Lalternative\Spore\Model\ListTemplatesResponse',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\Lalternative\Spore\Model\ListTemplatesResponse';
        $request = $this->listTemplatesRequest($contentType);
    ...
    public function previewTemplateWithHttpInfo($id, $request, string $contentType = self::contentTypes['previewTemplate'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Lalternative\Spore\Model\PreviewTemplateResponse',
                        $request,
                        $response,
                    );
                case 400:
