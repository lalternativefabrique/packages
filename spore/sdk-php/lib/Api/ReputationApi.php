...
class ReputationApi
{
     ...
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getReputation'] to see the possible values for this operation
     *
     * @throws \Lalternative\Spore\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Lalternative\Spore\Model\RepositoryStateView|\Lalternative\Spore\Model\EchoHTTPError
     */
    public function getReputation(string $contentType = self::contentTypes['getReputation'][0])
    {
        list($response) = $this->getReputationWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation getReputationWithHttpInfo
     *
     * Get the current sending reputation for the authenticated tenant
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getReputation'] to see the possible values for this operation
     ...
     * @throws \Lalternative\Spore\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Lalternative\Spore\Model\RepositoryStateView|\Lalternative\Spore\Model\EchoHTTPError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReputationWithHttpInfo(string $contentType = self::contentTypes['getReputation'][0])
    {
        $request = $this->getReputationRequest($contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Lalternative\Spore\Model\RepositoryStateView',
                        $request,
                        $response,
                    );
                case 401:
     ...
     */
    public function getReputationAsync(string $contentType = self::contentTypes['getReputation'][0])
    {
        return $this->getReputationAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getReputationAsyncWithHttpInfo
     *
     * Get the current sending reputation for the authenticated tenant
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getReputation'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getReputationAsyncWithHttpInfo(string $contentType = self::contentTypes['getReputation'][0])
    {
        $returnType = '\Lalternative\Spore\Model\RepositoryStateView';
        $request = $this->getReputationRequest($contentType);
    ...
    /**
     * Create request for operation 'getReputation'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getReputation'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function getReputationRequest(string $contentType = self::contentTypes['getReputation'][0])
    {


        $resourcePath = '/reputation';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation unfreezeTenantReputation
     *
    ...
    /**
     * Operation unfreezeTenantReputationWithHttpInfo
     *
     * Lift a sending freeze on a tenant
     *
     * @param  string $tenant_id Tenant id (required)
    ...
    public function unfreezeTenantReputationWithHttpInfo($tenant_id, $request, string $contentType = self::contentTypes['unfreezeTenantReputation'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Lalternative\Spore\Model\UnfreezeResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    /**
     * Operation unfreezeTenantReputationAsync
     *
     * Lift a sending freeze on a tenant
     *
     * @param  string $tenant_id Tenant id (required)
    ...
    /**
     * Operation unfreezeTenantReputationAsyncWithHttpInfo
     *
     * Lift a sending freeze on a tenant
     *
     * @param  string $tenant_id Tenant id (required)
    ...
    public function unfreezeTenantReputationRequest($tenant_id, $request, string $contentType = self::contentTypes['unfreezeTenantReputation'][0])
    {
        ...
        if ($tenant_id === null || (is_array($tenant_id) && count($tenant_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tenant_id when calling unfreezeTenantReputation'
            );
        }
        ...
        $resourcePath = '/internal/reputation/{tenantId}/unfreeze';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
