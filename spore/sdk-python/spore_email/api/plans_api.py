...
class PlansApi:
    ...
    def get_tenant_plan(
        ...
        _param = self._get_tenant_plan_serialize(
    ...
    @validate_call
    def get_tenant_plan_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_tenant_plan_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_tenant_plan_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
