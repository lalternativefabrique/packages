...
class BrandingApi:
    ...
    def extract_brand_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExtractBrandResponse]:
        """Extract a branding suggestion from a URL or HTML
    ...
    def _extract_brand_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/identities/{id}/brand/extract',
    ...
    def get_brand_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RepositoryBrandView]:
        """Get the branding for a sending identity
    ...
    def _get_brand_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/identities/{id}/brand',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
