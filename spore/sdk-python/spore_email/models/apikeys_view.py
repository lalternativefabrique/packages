...
class ApikeysView(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "id", "identityId", "lastUsedAt", "name", "prefix", "revokedAt", "tenantId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApikeysView from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApikeysView from a dict"""
        if obj is None:
            return None
