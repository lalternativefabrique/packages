...
class SetBrandResponse(BaseModel):
    """
    SetBrandResponse
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["appName", "fontFamily", "footerText", "identityId", "locale", "logoUrl", "primaryColor", "supportEmail", "tenantId", "websiteUrl"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SetBrandResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SetBrandResponse from a dict"""
        if obj is None:
            return None
