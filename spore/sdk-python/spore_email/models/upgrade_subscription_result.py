...
class UpgradeSubscriptionResult(BaseModel):
    ...
    """ # noqa: E501
    charged_cents: Optional[StrictInt] = Field(default=None, alias="chargedCents")
    ...
    __properties: ClassVar[List[str]] = ["chargedCents", "currency", "paymentId", "planName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpgradeSubscriptionResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpgradeSubscriptionResult from a dict"""
        if obj is None:
            return None
