...
class ProvidersSuggestion(BaseModel):
    """
    ProvidersSuggestion
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["appName", "fontFamily", "logoUrl", "primaryColor", "websiteUrl"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProvidersSuggestion from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProvidersSuggestion from a dict"""
        if obj is None:
            return None
