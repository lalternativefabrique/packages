...
from spore_email.configuration import Configuration
from spore_email.api_response import ApiResponse, T as ApiResponseT
import spore_email.models
from spore_email import rest
from spore_email.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(spore_email.models, klass)
