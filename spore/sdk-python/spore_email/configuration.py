...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        ...
        "InternalToken": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = spore_email.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.sporee.fr" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("spore_email")
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        if 'InternalToken' in self.api_key:
            auth['InternalToken'] = {
                'type': 'api_key',
                'in': 'header',
